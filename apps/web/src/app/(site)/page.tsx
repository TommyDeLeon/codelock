...
export default function LandingPage() {
  return <>
    ...
    <section className="lock-spread" aria-label="The desktop lock, documented">
      <div className="spread-heading site-frame"><p className="eyebrow">The interruption</p><p>The timer ends. The problem begins.</p></div>
    ...
    <section className="site-frame section-space argument-spread">
      <div className="argument-heading"><p className="eyebrow">The condition</p><h2 className="display display-lg">It works.<br /><em>It is still<br />too slow.</em></h2><p className="prose-site">Correct output answers one question. The runtime budget asks another: did you find an efficient way to get there?</p><Link href="/how-it-works" className="text-link">Read the arithmetic →</Link></div>
    ...
    <section className="limits-band site-frame section-space">
      <div className="section-intro"><p className="eyebrow">The limits, before you install</p><h2 className="display display-lg">A commitment.<br /><em>Not a cage.</em></h2><p className="prose-site">Every platform has a way out. The purpose is to make returning to the work a deliberate choice. The hardware is still yours.</p></div>

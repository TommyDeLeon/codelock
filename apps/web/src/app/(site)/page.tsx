...
export default function LandingPage() {
  return <>
    ...
    <section className="site-frame section-space argument-spread">
      ...
      <div className="verdict-evidence"><Reportage capture="codelock-verdict-light" number="02" className="verdict-crop" alt="Demo verdict: all three tests passed, but 420 milliseconds exceeds the 189 millisecond budget" caption="Three tests passed. At 420ms against a 189ms budget, this captured demo run is rejected as too slow. Correctness alone does not clear the gate." /><p className="evidence-footnote">The capture records one run, not a benchmark for your machine. Reference runtimes are calibrated per language on your own judge hardware.</p></div>
    </section>

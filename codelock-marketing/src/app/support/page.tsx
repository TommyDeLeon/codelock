...
export default function SupportPage() {
  return <>
    <section className="rule-b hero-stage"><div className="site-frame section-space">
      ...
      <div className="recovery-lead"><p className="text-[17px] text-accent">On desktop, hold Escape for ten seconds.</p><p className="prose-site mt-4">The overlay exits and the session counts as failed. That is an intentional recovery path, including when you need to repair your local setup.</p></div>
    </div></section>
    ...
    <section className="rule-b"><div className="site-frame section-space mechanism-layout">
      <div><p className="eyebrow">If you need another way out</p><h2 className="display display-md mt-4">The hardware<br />is still yours.</h2></div>
    ...
    <section className="rule-b bg-surface-2/50"><div className="site-frame section-space"><p className="eyebrow">If something is not working</p><h2 className="display display-md mt-4">Check the mechanism.</h2>
    ...
    <section><div className="site-frame section-space mechanism-layout">
      <div><p className="eyebrow">If you find a bug</p><h2 className="display display-md mt-4">Leave a useful trail.</h2></div>
